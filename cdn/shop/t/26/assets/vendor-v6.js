...
function(t, e) {
    ...
    if (t.addEventListener) {
        var n = /\s+/g,
            ...
            l = function(t, i, s) {
                ...
                i._lazybgset && i._lazybgset.parentNode == i && i.removeChild(i._lazybgset), Object.defineProperty(s, "_lazybgset", {
                    ...
                    value: a,
                    writable: !0
                }), t = t.replace(n, " ").split(o), a.style.display = "none", s.className = lazySizesConfig.lazyClass, 1 != t.length || l || (l = "auto"), t.forEach((function(t) {
                    var i = e.createElement("source");
                    l && "auto" != l && i.setAttribute("sizes", l), t.match(r) && (i.setAttribute(lazySizesConfig.srcsetAttr, RegExp.$1), RegExp.$2 && i.setAttribute("media", lazySizesConfig.customMedia[RegExp.$2] || RegExp.$2)), a.appendChild(i)
                })), l && (s.setAttribute(lazySizesConfig.sizesAttr, l), i.removeAttribute(lazySizesConfig.sizesAttr), i.removeAttribute("sizes")), u && s.setAttribute("data-optimumx", u), c && s.setAttribute("data-ratio", c), a.appendChild(s), i.appendChild(a)
            },
            c = function(t) {
        ...
        addEventListener("lazybeforeunveil", (function(t) {
            var n, o, r;
            !t.defaultPrevented && (n = t.target.getAttribute("data-bgset")) && (r = t.target, (o = e.createElement("img")).alt = "", o._lazybgsetLoading = !0, t.detail.firesLoad = !0, l(n, r, o), setTimeout((function() {
                i.loader.unveil(o), i.rAF((function() {
                    i.fire(o, "_lazyloaded", {}, !0, !0), o.complete && c({
                        target: o
                    })
                }))
            })))
        })), e.addEventListener("load", c, !0), t.addEventListener("lazybeforesizes", (function(t) {
            if (t.detail.instance == i && t.target._lazybgset && t.detail.dataAttr) {
                ...
                a[e] && (t.target._lazysizesParentFit = e, i.rAF((function() {
    ...
    if (!r || !(r && "objectPosition" in o)) {
        var d = function(t) {
            if (t.detail.instance == i) {
                ...
                !n.fit || r && "center" == n.position || function(t, e) {
                    var n, o, r = i.cfg,
                        s = t.cloneNode(!1),
                        a = s.style,
                        u = function() {
                            var e = t.currentSrc || t.src;
                            e && o !== e && (o = e, a.backgroundImage = "url(" + (c.test(e) ? JSON.stringify(e) : e) + ")", n || (n = !0, i.rC(s, r.loadingClass), i.aC(s, r.loadedClass)))
                        },
                        d = function() {
                            i.rAF(u)
                        };
                    t._lazysizesParentFit = e.fit, t.addEventListener("lazyloaded", d, !0), t.addEventListener("load", d, !0), s.addEventListener("load", (function() {
                        ...
                        var n = t,
                            o = t.parentNode;
                        "PICTURE" == o.nodeName.toUpperCase() && (n = o, o = o.parentNode), i.rC(s, r.loadedClass), i.rC(s, r.lazyClass), i.aC(s, r.loadingClass), i.aC(s, r.objectFitClass || "lazysizes-display-clone"), s.getAttribute(r.srcsetAttr) && s.setAttribute(r.srcsetAttr, ""), s.getAttribute(r.srcAttr) && s.setAttribute(r.srcAttr, ""), s.src = l, s.srcset = "", a.backgroundRepeat = "no-repeat", a.backgroundPosition = e.position, a.backgroundSize = e.fit, n.style.display = "none", t.setAttribute("data-parent-fit", e.fit), t.setAttribute("data-parent-container", "prev"), o.insertBefore(s, n), t._lazysizesParentFit && delete t._lazysizesParentFit, t.complete && u()
                    }))
                }(e, n)
            }
        };
        ...
        var n = /\s+(\d+)(w|h)\s+(\d+)(w|h)/,
            ...
            a = {
                ...
                getFit: function(t) {
                    ...
                    return !l.fit && s && (e = s.match(o)) && (l.fit = e[1]), l.fit ? (!(i = t._lazysizesParentContainer || t.getAttribute("data-parent-container")) && s && (e = s.match(r)) && (i = e[1]), l.parent = a.getParent(t, i)) : l.fit = n.objectFit, l
                },
                getImageRatio: function(e) {
                    var i, o, r, a, l, c = e.parentNode,
                        u = c && s.test(c.nodeName || "") ? c.querySelectorAll("source, img") : [e];
                    for (i = 0; i < u.length; i++)
                        if (o = (e = u[i]).getAttribute(lazySizesConfig.srcsetAttr) || e.getAttribute("srcset") || e.getAttribute("data-pfsrcset") || e.getAttribute("data-risrcset") || "", r = e._lsMedia || e.getAttribute("media"), r = lazySizesConfig.customMedia[e.getAttribute("data-media") || r] || r, o && (!r || (t.matchMedia && matchMedia(r) || {}).matches)) {
                            !(a = parseFloat(e.getAttribute("data-aspectratio"))) && (l = o.match(n)) && (a = "w" == l[2] ? l[1] / l[3] : l[3] / l[1]);
                            break
                        }
                    return a
                },
                calculateSize: function(t, e) {
                    var i, n, o, r, s = this.getFit(t),
                        a = s.fit,
                        l = s.parent;
                    return "width" == a || ("contain" == a || "cover" == a) && (o = this.getImageRatio(t)) ? (l ? e = l.clientWidth : l = t, r = e, "width" == a ? r = e : (n = l.clientHeight) > 40 && (i = e / n) && ("cover" == a && o > i || "contain" == a && i > o) && (r = e * (o / i)), r) : e
                }
            };
...
function(t, e) {
    var i = function(t, e) {
        ...
        if (e.getElementsByClassName) {
            ...
            var D = function() {
                    var s, d, f, p, m, C, D, I, M, T, L, N, F, O, R = /^img$/i,
                        U = /^iframe$/i,
                        ...
                        B = function(t, i) {
                            ...
                            for (I -= i, L += i, M -= i, T += i; s && (r = r.offsetParent) && r != e.body && r != o;)(s = (E(r, "opacity") || 1) > 0) && "visible" != E(r, "overflow") && (n = r.getBoundingClientRect(), s = T > n.left && M < n.right && L > n.top - 1 && I < n.bottom + 1);
                            return s
                        },
                        Z = function() {
                            var t, r, a, c, u, f, h, m, g, v = i.elements;
                            if ((p = n.loadMode) && H < 8 && (t = v.length)) {
                                r = 0, V++, null == F && ("expand" in n || (n.expand = o.clientHeight > 500 && o.clientWidth > 500 ? 500 : 370), N = n.expand, F = N * n.expFactor), W < F && H < 1 && V > 2 && p > 2 && !e.hidden ? (W = F, V = 0) : W = p > 1 && V > 1 && H < 6 ? N : 0;
                                for (; r < t; r++)
                                    if (v[r] && !v[r]._lazyRace)
                                        if (j)
                                            if ((m = v[r][l]("data-expand")) && (f = 1 * m) || (f = W), g !== f && (C = innerWidth + f * O, D = innerHeight + f, h = -1 * f, g = f), a = v[r].getBoundingClientRect(), (L = a.bottom) >= h && (I = a.top) <= D && (T = a.right) >= h * O && (M = a.left) <= C && (L || T || M || I) && (n.loadHidden || "hidden" != E(v[r], "visibility")) && (d && H < 3 && !m && (p < 3 || V < 4) || B(v[r], f))) {
                                                if (Q(v[r]), u = !0, H > 9) break
                                            } else !u && d && !c && H < 4 && V < 4 && p > 2 && (s[0] || n.preloadAfterLoad) && (s[0] || !m && (L || T || M || I || "auto" != v[r][l](n.sizesAttr))) && (c = s[0] || v[r]);
                                else Q(v[r]);
                                c && !u && Q(c)
                            }
                        },
                        X = P(Z),
                        G = function(t) {
                            y(t.target, n.loadedClass), b(t.target, n.loadingClass), x(t.target, Y), w(t.target, "lazyloaded")
                        },
                        $ = A(G),
                        Y = function(t) {
                            $({
                        ...
                        J = A((function(t, e, i, o, r) {
                            ...
                            (p = w(t, "lazybeforeunveil", e)).defaultPrevented || (o && (i ? y(t, n.autosizesClass) : t.setAttribute("sizes", o)), a = t[l](n.srcsetAttr), s = t[l](n.srcAttr), r && (d = (c = t.parentNode) && h.test(c.nodeName || "")), m = e.firesLoad || "src" in t && (a || s || d), p = {
                                target: t
                            }, m && (x(t, q, !0), clearTimeout(f), f = u(q, 2500), y(t, n.loadingClass), x(t, Y, !0)), d && g.call(c.getElementsByTagName("source"), K), a ? t.setAttribute("srcset", a) : s && !d && (U.test(t.nodeName) ? function(t, e) {
                                try {
                    ...
                    return {
                        _: function() {
                            m = r.now(), i.elements = e.getElementsByClassName(n.lazyClass), s = e.getElementsByClassName(n.lazyClass + " " + n.preloadClass), O = n.hFac, c("scroll", X, !0), c("resize", X, !0), t.MutationObserver ? new MutationObserver(X).observe(o, {
                                childList: !0,
                                subtree: !0,
                                attributes: !0
...
function(t, e) {
    ...
    return function(t, e, i, n) {
        ...
        o.extend(s, n);
        var a, l, c, u, d, f, h, p, m, g, v, y, b, x, w, S, E, C, z, A, P, k, D, _, I, M, T, L, N, F, O, R, U, j, W, H, V, q, B, Z, X, G, $, Y, K, J, Q, tt, et, it, nt, ot, rt, st, at, lt, ct = {
                x: 0,
                y: 0
            },
            ut = {
            ...
            kt = function(t, e, i, n, o) {
                (!xt || o && o !== r.currItem) && (n /= o ? o.fitRatio : r.currItem.fitRatio), t[k] = y + e + "px, " + i + "px" + b + " scale(" + n + ")"
            },
            Dt = function(t) {
                et && (t && (g > r.currItem.fitRatio ? xt || (Ye(r.currItem, !1, !0), xt = !0) : xt && (Ye(r.currItem), xt = !1)), kt(et, dt.x, dt.y, g))
            },
            _t = function(t) {
            ...
            Ft = null,
            Ot = function() {
                Ft && (o.unbind(document, "mousemove", Ot), o.addClass(t, "pswp--has_mouse"), s.mouseUsed = !0, zt("mouseUsed")), Ft = setTimeout((function() {
                    Ft = null
                }), 100)
            },
            Rt = function(t, e) {
            ...
            Wt = function(t, e, i, n) {
                return n === r.currItem.initialZoomLevel ? (i[t] = r.currItem.initialPosition[t], !0) : (i[t] = Tt(t, n), i[t] > e.min[t] ? (i[t] = e.min[t], !0) : i[t] < e.max[t] && (i[t] = e.max[t], !0))
            },
            Ht = function(t) {
                var e = "";
            ...
            Yt = function(t, e, i, n, o, r, s) {
                ...
                var c = function() {
                    if (Bt[t]) {
                        if ((a = At() - l) >= n) return Xt(t), r(i), void(s && s());
                        r((i - e) * o(a / n) + e), Bt[t].raf = I(c)
                    }
                };
                c()
            },
            Kt = {
                ...
                setScrollOffset: function(t, e) {
                    pt.x = t, F = pt.y = e, zt("updateScrollOffset", pt)
                },
                applyZoomPan: function(t, e, i, n) {
                    dt.x = e, dt.y = i, g = t, Dt(n)
                },
                init: function() {
                    if (!a && !l) {
                        var i;
                        r.framework = o, r.template = t, r.bg = o.getChildByClass(t, "pswp__bg"), T = t.className, a = !0, O = o.detectFeatures(), I = O.raf, M = O.caf, k = O.transform, N = O.oldIE, r.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), r.container = o.getChildByClass(r.scrollWrap, "pswp__container"), d = r.container.style, r.itemHolders = S = [{
                            ...
                            function() {
                                if (k) {
                                    ...
                                    return y = "translate" + (e ? "3d(" : "("), void(b = O.perspective ? ", 0px)" : ")")
                                }
                                k = "left", o.addClass(t, "pswp--ie"), It = function(t, e) {
                                    e.left = t + "px"
                                }, _t = function(t) {
                        ...
                        zt("firstUpdate"), u = u || s.index || 0, (isNaN(u) || u < 0 || u >= We()) && (u = 0), r.currItem = je(u), (O.isOldIOSPhone || O.isOldAndroid) && (vt = !1), t.setAttribute("aria-hidden", "false"), s.modal && (vt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === F && (zt("initialLayout"), F = L = o.getScrollY());
                        var c = "pswp--open ";
                        for (s.mainClass && (c += s.mainClass + " "), s.showHideOpacity && (c += "pswp--animate_opacity "), c += _ ? "pswp--touch" : "pswp--notouch", c += O.animationName ? " pswp--css_animation" : "", c += O.svg ? " pswp--svg" : "", o.addClass(t, c), r.updateSize(), f = -1, gt = null, i = 0; i < 3; i++) It((i + f) * mt.x, S[i].el.style);
                        N || o.bind(r.scrollWrap, p, r), Ct("initialZoomInEnd", (function() {
                            r.setContent(S[0], u - 1), r.setContent(S[2], u + 1), S[0].el.style.display = S[2].el.style.display = "block", s.focus && t.focus(), o.bind(document, "keydown", r), O.transform && o.bind(r.scrollWrap, "click", r), s.mouseUsed || o.bind(document, "mousemove", Ot), o.bind(window, "resize scroll orientationchange", r), zt("bindEvents")
                ...
                close: function() {
                    a && (a = !1, l = !0, zt("close"), o.unbind(window, "resize scroll orientationchange", r), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", r), o.unbind(document, "mousemove", Ot), O.transform && o.unbind(r.scrollWrap, "click", r), B && o.unbind(window, h, r), clearTimeout(R), zt("unbindEvents"), He(r.currItem, null, !0, r.destroy))
                },
                destroy: function() {
                    zt("destroy"), Fe && clearTimeout(Fe), t.setAttribute("aria-hidden", "true"), t.className = T, x && clearInterval(x), o.unbind(r.scrollWrap, p, r), o.unbind(window, "scroll", r), pe(), $t(), Et = null
                },
                panTo: function(t, e, i) {
                    i || (t > tt.min.x ? t = tt.min.x : t < tt.max.x && (t = tt.max.x), e > tt.min.y ? e = tt.min.y : e < tt.max.y && (e = tt.max.y)), dt.x = t, dt.y = e, Dt()
                },
                ...
                goTo: function(t) {
                    var e = (t = St(t)) - u;
                    gt = e, u = t, r.currItem = je(u), ht -= e, Mt(mt.x * ht), $t(), it = !1, r.updateCurrItem()
                },
                next: function() {
                    r.goTo(u + 1)
                },
                ...
                updateCurrItem: function(t) {
                    if (0 !== gt) {
                        ...
                        if (!(t && i < 2)) {
                            ...
                            for (var n = 0; n < i; n++) gt > 0 ? (e = S.shift(), S[2] = e, f++, It((f + 2) * mt.x, e.el.style), r.setContent(e, u - i + n + 1 + 1)) : (e = S.pop(), S.unshift(e), f--, It(f * mt.x, e.el.style), r.setContent(e, u + i - n - 1 - 1));
                            if (et && 1 === Math.abs(gt)) {
                                var o = je(E);
                                o.initialZoomLevel !== g && (Ze(o, ft), Ye(o), _t(o))
                            }
                ...
                updateSize: function(e) {
                    ...
                    if (ft.x = r.scrollWrap.clientWidth, ft.y = r.scrollWrap.clientHeight, qt(), mt.x = ft.x + Math.round(ft.x * s.spacing), mt.y = ft.y, Mt(mt.x * ht), zt("beforeResize"), void 0 !== f) {
                        for (var n, a, l, c = 0; c < 3; c++) n = S[c], It((c + f) * mt.x, n.el.style), l = u + c - 1, s.loop && We() > 2 && (l = St(l)), (a = je(l)) && (w || a.needsUpdate || !a.bounds) ? (r.cleanSlide(a), r.setContent(n, l), 1 === c && (r.currItem = a, r.updateCurrZoomItem(!0)), a.needsUpdate = !1) : -1 === n.index && l >= 0 && r.setContent(n, l), a && a.container && (Ze(a, ft), Ye(a), _t(a));
                        w = !1
                    }
                    v = g = r.currItem.initialZoomLevel, (tt = r.currItem.bounds) && (dt.x = tt.center.x, dt.y = tt.center.y, Dt(!0)), zt("resize")
                },
                zoomTo: function(t, e, i, n, r) {
                    ...
                    Nt(a);
                    var d = function(e) {
                        1 === e ? (g = t, dt.x = a.x, dt.y = a.y) : (g = (t - l) * e + l, dt.x = (a.x - c) * e + c, dt.y = (a.y - u) * e + u), r && r(e), Dt(1 === e)
                    };
            ...
            ze = function(t) {
                ...
                return D ? (lt = 0, ne.forEach((function(t) {
            ...
            Pe = function(t) {
                if (!("mousedown" === t.type && t.button > 0))
                    ...
                    var i = ze(t),
                        n = i.length;
                    K = null, $t(), B && 1 !== n || (B = ot = !0, o.bind(window, h, r), H = at = rt = V = Y = G = Z = X = !1, nt = null, zt("firstTouchStart", i), Lt(ut, dt), ct.x = ct.y = 0, Lt(ee, i[0]), Lt(ie, ee), oe.x = mt.x * ht, re = [{
                        x: ee.x,
                        y: ee.y
                    }], j = U = At(), Rt(g, !0), pe(), me()), !J && n > 1 && !it && !Y && (v = g, X = !1, J = Z = !0, ct.y = ct.x = 0, Lt(ut, dt), Lt(Jt, i[0]), Lt(Qt, i[1]), xe(Jt, Qt, fe), de.x = Math.abs(fe.x) - dt.x, de.y = Math.abs(fe.y) - dt.y, Q = he(Jt, Qt))
                }
            },
            ke = function(t) {
            ...
            De = function() {
                if (K) {
                    var t = K.length;
                    if (0 !== t)
                        if (Lt(Jt, K[0]), te.x = Jt.x - ee.x, te.y = Jt.y - ee.y, J && t > 1) {
                            if (ee.x = Jt.x, ee.y = Jt.y, !te.x && !te.y && function(t, e) {
                                    return t.x === e.x && t.y === e.y
                                }(K[1], Qt)) return;
                            Lt(Qt, K[1]), X || (X = !0, zt("zoomGestureStarted"));
                            var e = he(Jt, Qt),
                                i = Le(e);
                            ...
                            if (i < o)
                                if (s.pinchToClose && !at && v <= r.currItem.initialZoomLevel) {
                                    var l = 1 - (o - i) / (o / 1.2);
                                    Pt(l), zt("onPinchClose", l), rt = !0
                                } else(n = (o - i) / o) > 1 && (n = 1), i = o - n * (o / 3);
                            else i > a && ((n = (i - a) / (6 * o)) > 1 && (n = 1), i = a + n * o);
                            n < 0 && (n = 0), e, xe(Jt, Qt, le), ct.x += le.x - fe.x, ct.y += le.y - fe.y, Lt(fe, le), dt.x = Tt("x", i), dt.y = Tt("y", i), H = i > g, g = i, Dt()
                        } else {
                            if (!nt) return;
                            if (ot && (ot = !1, Math.abs(te.x) >= 10 && (te.x -= K[0].x - ie.x), Math.abs(te.y) >= 10 && (te.y -= K[0].y - ie.y)), ee.x = Jt.x, ee.y = Jt.y, 0 === te.x && 0 === te.y) return;
                            if ("v" === nt && s.closeOnVerticalDrag && "fit" === s.scaleMode && g === r.currItem.initialZoomLevel) {
                                ct.y += te.y, dt.y += te.y;
                                var c = we();
                                return V = !0, zt("onVerticalDrag", c), Pt(c), void Dt()
                            }! function(t, e, i) {
                                if (t - j > 50) {
                                    var n = re.length > 2 ? re.shift() : {};
                                    n.x = e, n.y = i, re.push(n), j = t
                                }
                            }(At(), Jt.x, Jt.y), G = !0, tt = r.currItem.bounds, Ae("x", te) || (Ae("y", te), Nt(dt), Dt())
                        }
                }
            },
            _e = function(t) {
                ...
                var e;
                if (zt("pointerUp"), ye(t, !1) && t.preventDefault(), D) {
                ...
                var c = -1;
                if (0 === l && (B = !1, o.unbind(window, h, r), pe(), J ? c = 0 : -1 !== ce && (c = At() - ce)), ce = 1 === l ? At() : -1, n = -1 !== c && c < 150 ? "zoom" : "swipe", J && l < 2 && (J = !1, 1 === l && (n = "zoomPointerUp"), zt("zoomGestureEnded")), K = null, G || X || it || V)
                    if ($t(), W || (W = Ie()), W.calculateSwipeSpeed("x"), V) {
                        if (we() < s.verticalDragRange) r.close();
                        else {
                            var u = dt.y,
                                d = st;
                            Yt("verticalDrag", 0, 1, 300, o.easing.cubic.out, (function(t) {
                                dt.y = (r.currItem.initialPosition.y - u) * t + u, Pt((1 - d) * t + d), Dt()
                            })), zt("onVerticalDrag", 1)
                        }
                    } else {
                        if ((Y || it) && 0 === l) {
                        ...
                        it || ("swipe" === n ? !Y && g > r.currItem.fitRatio && Me(W) : Ne())
                    }
            },
            Ie = function() {
                var t, e, i = {
            ...
            Me = function(t) {
                ...
                Gt("zoomPan"), t.lastNow = At(), t.panAnimLoop()
            },
            Te = function(t, e) {
                var i, n, a;
                if (it || (ae = u), "swipe" === t) {
                ...
                var d, f = mt.x * ht,
                    h = Math.abs(f - ue.x);
                return i || f > ue.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? h / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, ae === u && (i = !1), it = !0, zt("mainScrollAnimStart"), Yt("mainScroll", ue.x, f, d, o.easing.cubic.out, Mt, (function() {
                    $t(), it = !1, ae = -1, (i || ae !== u) && r.updateCurrItem(), zt("mainScrollAnimComplete")
            ...
            publicMethods: {
                initGestures: function() {
                    var t = function(t, e, i, n, o) {
                        C = t + e, z = t + i, A = t + n, P = o ? t + o : ""
                    };
                    (D = O.pointerEvent) && O.touch && (O.touch = !1), D ? navigator.msPointerEnabled ? t("MSPointer", "Down", "Move", "Up", "Cancel") : t("pointer", "down", "move", "up", "cancel") : O.touch ? (t("touch", "start", "move", "end", "cancel"), _ = !0) : t("mouse", "down", "move", "up"), h = z + " " + A + " " + P, p = C, D && !_ && (_ = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), r.likelyTouchDevice = _, m[C] = Pe, m[z] = ke, m[A] = _e, P && (m[P] = m[A]), O.touch && (p += " mousedown", h += " mousemove mouseup", m.mousedown = m[C], m.mousemove = m[z], m.mouseup = m[A]), _ || (s.allowPanToNext = !1)
                }
            }
        });
        var Fe, Oe, Re, Ue, je, We, He = function(e, i, n, a) {
                var l;
                Fe && clearTimeout(Fe), Ue = !0, Re = !0, e.initialLayout ? (l = e.initialLayout, e.initialLayout = null) : l = s.getThumbBoundsFn && s.getThumbBoundsFn(u);
                var d = n ? s.hideAnimationDuration : s.showAnimationDuration,
                    f = function() {
                        Xt("initialZoom"), n ? (r.template.removeAttribute("style"), r.bg.removeAttribute("style")) : (Pt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), zt("initialZoom" + (n ? "OutEnd" : "InEnd"))), a && a(), Ue = !1
                    };
                if (!d || !l || void 0 === l.x) return zt("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Lt(dt, e.initialPosition), Dt(), t.style.opacity = n ? 0 : 1, Pt(1), void(d ? setTimeout((function() {
                    f()
                }), d) : f());
                var h, p;
                h = c, p = !r.currItem.src || r.currItem.loadError || s.showHideOpacity, e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, dt.x = l.x, dt.y = l.y - L, r[p ? "template" : "bg"].style.opacity = .001, Dt()), Gt("initialZoom"), n && !h && o.removeClass(t, "pswp--animated-in"), p && (n ? o[(h ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout((function() {
                    ...
                    if (zt("initialZoom" + (n ? "Out" : "In")), n) {
                        var i = l.w / e.w,
                            ...
                            a = st,
                            c = function(e) {
                                1 === e ? (g = i, dt.x = l.x, dt.y = l.y - F) : (g = (i - s) * e + s, dt.x = (l.x - r.x) * e + r.x, dt.y = (l.y - F - r.y) * e + r.y), Dt(), p ? t.style.opacity = 1 - e : Pt(a - e * a)
                            };
                        h ? Yt("initialZoom", 0, 1, d, o.easing.cubic.out, c, f) : (c(1), Fe = setTimeout(f, d + 20))
                    } else g = e.initialZoomLevel, Lt(dt, e.initialPosition), Dt(), Pt(1), p ? t.style.opacity = 1 : Pt(1), Fe = setTimeout(f, d + 20)
                }), n ? 25 : 90)
            },
            Ve = {},
            qe = [],
            ...
            Xe = function(t, e, i, n, o, s) {
                e.loadError || n && (e.imageAppended = !0, Ye(e, n, e === r.currItem && xt), i.appendChild(n), s && setTimeout((function() {
        ...
        wt("Controller", {
            publicMethods: {
                ...
                initController: function() {
                    o.extend(s, Be, !0), r.items = Oe = i, je = r.getItemAt, We = s.getNumItemsFn, s.loop, We() < 3 && (s.loop = !1), Ct("beforeChange", (function(t) {
                        var e, i = s.preload,
                            n = null === t || t >= 0,
                            o = Math.min(i[0], We()),
                            a = Math.min(i[1], We());
                        ...
                        for (var t, e = 0; e < Oe.length; e++)(t = Oe[e]).container && (t.container = null), t.placeholder && (t.placeholder = null), t.img && (t.img = null), t.preloader && (t.preloader = null), t.loadError && (t.loaded = t.loadError = !1);
                        qe = null
                    }))
                },
                ...
                setContent: function(t, e) {
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), $e(l), Ze(l, ft), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Ye(l, n), Xe(0, l, c, n));
                        else {
                            if (l.loadComplete = function(i) {
                                    if (a) {
                                        if (t && t.index === e) {
                                            if ($e(i, !0)) return i.loadComplete = i.img = null, Ze(i, ft), _t(i), void(t.index === u && r.updateCurrZoomItem());
                                            i.imageAppended ? !Ue && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : O.transform && (it || Ue) ? qe.push({
                                                item: i,
                                                baseDiv: c,
                                                img: i.img,
                                                index: e,
                                ...
                                l.msrc && (f.src = l.msrc), Ye(l, f), c.appendChild(f), l.placeholder = f
                            }
                            l.loading || Ge(l), r.allowProgressiveImg() && (!Re && O.transform ? qe.push({
                                item: l,
                                baseDiv: c,
                                img: l.img,
                                index: e,
                        ...
                        Re || e !== u ? _t(l) : (et = c.style, He(l, n || l.img)), t.el.innerHTML = "", t.el.appendChild(c)
                    } else t.el.innerHTML = ""
                },
        ...
        wt("Tap", {
            ...
            publicMethods: {
                ...
                handleMouseWheel: function(t) {
                    if (g <= r.currItem.fitRatio) return s.modal && (!s.closeOnScroll || Zt || B ? t.preventDefault() : k && Math.abs(t.deltaY) > 2 && (c = !0, r.close())), !0;
    ...
    return function(t, e) {
        var i, n, o, r, s, a, l, c, u, d, f, h, p, m, g, v, y, b, x = this,
            ...
            _ = function(e) {
                ...
                return t.shout("shareLinkClick", e, i), !!i.href && (!!i.hasAttribute("download") || (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), E || D(), !1))
            },
            I = function() {
            ...
            T = 0,
            L = function() {
                clearTimeout(b), T = 0, u && x.setIdle(!1)
            },
            N = function(t) {
            ...
            F = function(t) {
                h !== t && (A(f, "preloader--active", !t), h = t)
            },
            O = function(i) {
                var s = i.vGap;
        ...
        x.init = function() {
            var s;
            e.extend(t.options, C, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), (d = t.listen)("onVerticalDrag", (function(t) {
                    S && t < .95 ? x.hideControls() : !S && t >= .95 && x.showControls()
                })), d("onPinchClose", (function(t) {
                    S && t < .9 ? (x.hideControls(), s = !0) : s && !S && t > .9 && x.showControls()
                    ...
                    E || D(), y && clearInterval(y), e.unbind(document, "mouseout", N), e.unbind(document, "mousemove", L), e.unbind(n, "pswpTap click", z), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
                })), d("destroy", (function() {
                ...
                function() {
                    ...
                    e.bind(document, "mousemove", L), e.bind(document, "mouseout", N), y = setInterval((function() {
                        2 == ++T && x.setIdle(!0)
                    }), g.timeToIdle / 2)
            ...
            S && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), A(o, "caption--empty", !t.currItem.title)), w = !0) : w = !1, E || D(), P()
            ...
            if (!v)
                ...
                } else if (g.tapToToggleControls && (S ? x.hideControls() : x.showControls()), g.tapToClose && (e.hasClass(n, "pswp__img") || M(n))) return void t.close()
        }, x.onMouseOver = function(t) {
            var e = (t = t || window.event).target || t.srcElement;
            A(n, "ui--over-close", M(e))
...
function(t, e) {
    ...
    function G(e, i, n) {
        var a, d, m, g, v, y, b, x = window.navigator.pointerEnabled ? {
            ...
            _ = {},
            I = e.ownerDocument,
            M = i.documentElement || I.documentElement,
            T = I.body,
            L = "rtl" === I.dir || 1 === i.ort ? 0 : 100;
                ...
                return function(t, e) {
                    ...
                    if (t.preventDefault(), f || d) {
                        var m = i.keyboardPageMultiplier,
                            ...
                            v = vt(e)[g];
                        if (null === v) return !1;
                        !1 === v && (v = z.getDefaultStep(P[e], d, i.keyboardDefaultStep)), (u || c) && (v *= m), v = Math.max(v, 1e-7), v *= d ? -1 : 1, a = A[e] + v
        ...
        function H() {
            W(), v = d.map(R), ot("update" + E, (function(t, e, n) {
        ...
        function Y(t, e, n, o) {
            var r = function(r) {
                    var s, a, l = function(t, e, i) {
                        ...
                        e = e || p(I), (o || r) && (s = t.clientX + e.x, a = t.clientY + e.y);
                        return t.pageOffset = e, t.points = [s, a], t.cursor = o || r, t
                    }(r, o.pageOffset, o.target || e);
                    return !!l && (!(U() && !o.doNotReject) && (s = S, a = i.cssClasses.tap, !((s.classList ? s.classList.contains(a) : new RegExp("\\b" + a + "\\b").test(s.className)) && !o.doNotReject) && (!(t === x.start && void 0 !== l.buttons && l.buttons > 1) && ((!o.hover || !l.buttons) && (w || l.preventDefault(), l.calcPoint = l.points[i.ort], void n(l, o))))))
                },
                s = [];
        ...
        function K(t) {
            var e, n, o, r, s, l, u = 100 * (t - (e = a, n = i.ort, o = e.getBoundingClientRect(), r = e.ownerDocument, s = r.documentElement, l = p(r), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (l.x = 0), n ? o.top + l.y - s.clientTop : o.left + l.x - s.clientLeft)) / $();
        ...
        function tt(t, e) {
            e.handle && (h(e.handle, i.cssClasses.active), D -= 1), e.listeners.forEach((function(t) {
                M.removeEventListener(t[0], t[1])
            })), 0 === D && (h(S, i.cssClasses.drag), dt(), t.cursor && (T.style.cursor = "", T.removeEventListener("selectstart", s))), e.handleNumbers.forEach((function(t) {
        ...
        function et(t, e) {
            if (!e.handleNumbers.some(j)) {
                var n;
                if (1 === e.handleNumbers.length) n = d[e.handleNumbers[0]].children[0], D += 1, f(n, i.cssClasses.active);
                t.stopPropagation();
                var o = [],
                    r = Y(x.move, M, Q, {
                        target: t.target,
                ...
                o.push.apply(o, r.concat(a, l)), t.cursor && (T.style.cursor = getComputedStyle(t.target).cursor, d.length > 1 && f(S, i.cssClasses.drag), T.addEventListener("selectstart", s, !1)), e.handleNumbers.forEach((function(t) {
                    st("start", t)
                }))
            }
        }
        ...
        function st(t, e, n) {
            Object.keys(_).forEach((function(o) {
                ...
                t === r && _[o].forEach((function(t) {
                    t.call(yt, A.map(i.format.to), e, A.slice(), n || !1, P.slice(), yt)
                }))
            }))
        }
        ...
        function ft(t, e, n, o, r) {
            return r || (e = at(P, t, e, n, o, !1)), !1 !== e && (function(t, e) {
                P[t] = e, A[t] = z.fromStepping(e);
        ...
        function ht(t) {
            if (m[t]) {
                var e = 0,
                    n = 100;
                0 !== t && (e = P[t - 1]), t !== m.length - 1 && (n = P[t]);
                var o = n - e,
        ...
        function pt(t, e) {
            return null === t || !1 === t || void 0 === t ? P[e] : ("number" == typeof t && (t = String(t)), !1 !== (t = i.format.from(t)) && (t = z.toStepping(t)), !1 === t || isNaN(t) ? P[e] : t)
        }

        function mt(t, e, n) {
            var o = u(t),
                r = void 0 === P[0];
            e = void 0 === e || e, i.animate && !r && l(S, i.cssClasses.tap, i.animationDuration), k.forEach((function(t) {
                ft(t, pt(o[t], t), !0, !1, n)
            }));
            for (var s = 1 === k.length ? 0 : 1; s < k.length; ++s) k.forEach((function(t) {
                ft(t, P[t], !0, !0, n)
            }));
            dt(), k.forEach((function(t) {
                st("update", t), null !== o[t] && e && st("set", t)
            }))
        }

        function gt(t) {
            if (void 0 === t && (t = !1), t) return 1 === A.length ? A[0] : A.slice(0);
        ...
        f(y = S, i.cssClasses.target), 0 === i.dir ? f(y, i.cssClasses.ltr) : f(y, i.cssClasses.rtl), 0 === i.ort ? f(y, i.cssClasses.horizontal) : f(y, i.cssClasses.vertical), f(y, "rtl" === getComputedStyle(y).direction ? i.cssClasses.textDirectionRtl : i.cssClasses.textDirectionLtr), a = N(y, i.cssClasses.base),
            function(t, e) {
                ...
                d = [], (m = []).push(O(n, t[0]));
                for (var o = 0; o < i.handles; o++) d.push(F(e, o)), k[o] = o, m.push(O(n, t[o + 1]))
            }(i.connect, a), (b = i.events).fixed || d.forEach((function(t, e) {
                Y(x.start, t.children[0], et, {
                    handleNumbers: [e]
                })
            })), b.tap && Y(x.start, a, it, {}), b.hover && Y(x.move, a, nt, {
                hover: !0
        ...
        var yt = {
            ...
            updateOptions: function(t, e) {
                ...
                s.forEach((function(e) {
                    void 0 !== t[e] && (i[e] = a[e])
                })), z = a.spectrum, i.margin = a.margin, i.limit = a.limit, i.padding = a.padding, i.pips ? G(i.pips) : Z(), i.tooltips ? H() : W(), P = [], mt(r(t.start) ? t.start : o, e)
            },
            target: S,
            removePips: Z,
            removeTooltips: W,
    ...
    t.create = $, t.cssClasses = S, t.default = Y, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));